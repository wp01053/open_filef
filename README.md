...
For full list of changes see [CHANGELOG](https://pub.dev/packages/open_filef/changelog)

## Usage

To use this plugin, add [open_filef](https://pub.dev/packages/open_filef/install) as a dependency in your pubspec.yaml file.
```yaml
dependencies:
